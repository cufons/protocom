...
PROTOBUF_NAMESPACE_OPEN
template<> ::protocom::Test* Arena::CreateMaybeMessage<::protocom::Test>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace protocom {
...
class Test final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:protocom.Test) */ {
 public:
